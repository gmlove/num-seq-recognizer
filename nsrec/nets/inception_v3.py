...
from nsrec.nets import variable_scope_fn, trunc_normal, end_points_collection_name

default_scope_name = 'incepiton_v3'
...
def inception_v3_arg_scope(weight_decay=0.00004,
  ...
  """This function is from slim.nets.inception_v3.inception_v3_arg_scope
...
def _reduced_kernel_size_for_small_input(input_tensor, kernel_size):
  """This function is from slim.nets.inception_v3._reduced_kernel_size_for_small_input
...
def fc_layers(net,
  ...
  with slim.arg_scope([slim.batch_norm, slim.dropout],
    ...
    end_points = end_points_collection
